...
> **Evidence note.** The bundled logs are **real public attack captures** (Yamato `hayabusa-sample-evtx` / EVTX-ATTACK-SAMPLES) from other hosts — names like `MSEDGEWIN10` are baked into the evidence and shown **unaltered**.
