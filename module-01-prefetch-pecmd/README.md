...
> **Evidence note.** The data here is the real DFIR-Madness Case 001 evidence, so tool output shows its real baked-in names unaltered — host `DESKTOP-SDN1RPT`, malware `coreupdater.exe`.
